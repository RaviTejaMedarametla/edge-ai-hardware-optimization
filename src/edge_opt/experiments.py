...
from edge_opt.search import SearchConstraints, scale_architecture
...
def run_sweep(
    ...
    for width_multiplier in width_multipliers:
        scaled_model = scale_architecture(base_model, width_multiplier)
        for pruning in pruning_levels:
            candidate = structured_channel_prune(scaled_model, pruning)
            for precision in precisions:
                ...
                memory_ok = metrics.memory_mb <= constraints.active_memory_budget_mb
                energy_ok = metrics.energy_proxy_j <= constraints.max_energy_j
                row = {
                    "width_multiplier": width_multiplier,
                    "pruning_level": pruning,
                    "precision": precision,
                    "accepted": memory_ok and energy_ok,
                    "memory_ok": memory_ok,
                    "energy_ok": energy_ok,
                    "active_budget_mb": constraints.active_memory_budget_mb,
